...
const AlgorandLogoFull = ({ classes, className = '' }) => {
    return (
        <svg
            className={className}
            version="1.1"
        ...
        >
            <g>
                <g>
                    <path className={classes.fill} d="M457.8,233.2v180.5H421V233.2H457.8z" />
                    <path
...
AlgorandLogoFull.propTypes = {
    classes: PropTypes.object,
    className: PropTypes.string,
};
export default withStyles(st)(AlgorandLogoFull);
