...
const Operation = ({ classes }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45.939 33.628">
            <g id="Group_2572" data-name="Group 2572" transform="translate(-585 -341)">
                <path
                    id="Path_1208"
                    data-name="Path 1208"
                    d="M89.443,116.392a40.921,40.921,0,0,1-21.214-.634c-4.406-1.436-8.815-3.782-11.407-7.764a17.493,17.493,0,0,0,.466,5.106,11.016,11.016,0,0,0,3.352,4.669,25.831,25.831,0,0,0,11.515,5.18,37.4,37.4,0,0,0,21.536-1.818c3.366-1.485,6.742-3.653,8.374-7.078.907-1.779.637-3.825.7-5.744C99.7,112.743,94.521,115.11,89.443,116.392Z"
                    transform="translate(528.178 250.883)"
...
export default withStyles(st)(Operation);
